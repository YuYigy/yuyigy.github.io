...
export async function generateMetadata({ params }: PostPageProps): Promise<Metadata> {
  ...
  return {
    title: `${post.title} | YuYi_gy's Blog`,
...
export default async function PostPage({ params }: PostPageProps) {
  ...
  return (
    <article className="max-w-4xl mx-auto px-4 py-16">
      {/* 半透明背景面板容器 */}
      <div className="bg-slate-800/20 backdrop-blur-md rounded-2xl p-8 md:p-12 border border-slate-gray/20 shadow-2xl shadow-space-blue/20">
        {/*
          CSS类详细解释:
          - bg-slate-800/20: 设置较浅的石板色背景，80%透明度(20%不透明度)，最大化星空背景的可见性和沉浸感
